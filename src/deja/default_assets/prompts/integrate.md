...
9. **Promote durable facts to entity pages.** When a signal reveals a STANDING fact — a policy ("Coach Rob needs ≥3 gymnasts or a parent present"), a role ("Dominique handles school logistics"), an invariant ("no dogs in the rental"), a recurring schedule ("Ruby practices Tuesdays only, Thu/Fri are 2014 team"), a preference, a hard constraint, a contact's title/company/location — add it to the relevant project or people page body in the SAME batch, not just to the event page that surfaced it. Event pages record what happened; entity pages record what's true going forward.
