...
MEETING_PROMPT_PATH = LIGHTHOUSE_HOME / "meeting_prompt.json"
MEETING_STATE_PATH = LIGHTHOUSE_HOME / "meeting_state.json"
...
def get_active_or_imminent_meeting(lookahead_minutes: int = 1) -> dict | None:
    ...
    """
    from lighthouse.observations.calendar import (
        _run_calendar_query,
