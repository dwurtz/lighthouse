...
from lighthouse.config import LIGHTHOUSE_HOME, REFLECT_MODEL, WIKI_DIR

log = logging.getLogger(__name__)

MEETING_AUDIO_DIR = LIGHTHOUSE_HOME / "meeting_audio"
...
"""
    ...
    try:
        from lighthouse.wiki import write_page
...
async def process_completed_meeting(session_dir: Path, state: dict) -> dict:
    ...
    obs_path = LIGHTHOUSE_HOME / "observations.jsonl"
    try:
