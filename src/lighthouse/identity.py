...
Lighthouse is a personal agent — every prompt needs some notion of who the
...
_GENERIC = {
    ...
    "email": "",
    "phone": "",
    "profile_md": "(No self-page configured. Create one at Lighthouse/people/<your-slug>.md with `self: true` in YAML frontmatter.)",
}
...
def _find_self_slug() -> str | None:
    ...
    try:
        from lighthouse import config as _cfg
