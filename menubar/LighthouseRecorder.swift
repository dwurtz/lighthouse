// LighthouseRecorder — standalone CLI for meeting/call audio capture.
//
...
//
// Usage:
//   LighthouseRecorder <session-dir>
...
guard CommandLine.arguments.count >= 2 else {
    log("Usage: LighthouseRecorder <session-dir>")
    exit(1)
}
...
// the parent Lighthouse.app's status item from the menu bar.
import AppKit
